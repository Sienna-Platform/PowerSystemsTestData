...
function thermal_generators_market_bid_ts(sys, node)
    ...
    PSY.set_variable_cost!(sys, gen1, market_bid_gen1, PSY.UnitSystem.NATURAL_UNITS) # breaking in PSB
    PSY.set_variable_cost!(sys, gen2, market_bid_gen2, PSY.UnitSystem.NATURAL_UNITS) # breaking in PSB
